...
//
console.log("l1", l1); // ['1', '2', id: 'l1']

//
function concatenate<S, T1 extends IdentificatedGeneric<S>>(
  list1: T1,
  list2: T1
): T1 {
  if (list1.id === list2.id) {
    // Comparison to ensure from the same id, possible because both extends IdentificatedGeneric
